...
from goat_plugins.erc20.token import DAI, USDC
...
BASE_RPC_URL = os.getenv("BASE_RPC_URL", "https://polygon-mainnet.g.alchemy.com/v2/7ef-K-JTGnIcWxZxuSn9DKzvrO6XpYzS")
...
2. Get swap quotes using uniswap_get_quote
   Example: "Get a quote to swap 1 DAI for USDC"
3. Execute token swaps using uniswap_swap_tokens
   Example: "Swap 0.1 DAI for USDC"
...
- 1 USDC = 1000000 (6 decimals)"""),
    ...
    tools = get_on_chain_tools(
        ...
        plugins=[
            erc20(options=ERC20PluginOptions(tokens=[USDC, DAI])),
    ...
    print("2. Get a quote to swap 1 DAI for USDC")
    print("3. Swap 0.1 DAI for USDC")
    print("\nMainnet token addresses:")
    print("- DAI: 0x8f3cf7ad23cd3cadbd9735aff958023239c6a063")
    print("- USDC: 0x3c499c542cef5e3811e1192ce70d8cc03d5c3359")
    print("\nTest amounts:")
    print("- 0.01 DAI = 10000000000000000 wei")
